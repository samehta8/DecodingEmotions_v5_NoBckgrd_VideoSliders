...
def append_rating_to_gsheets(rating_data, worksheet="ratings_4c_videos"):
    """
...
def read_ratings_from_gsheets(worksheet="ratings_4c_videos"):
    """
...
def get_rated_videos_for_user_from_gsheets(user_id, worksheet="ratings_4c_videos"):
    """
...
def append_user_to_gsheets(user_data, worksheet="users_4c_videos"):
    """
...
def read_users_from_gsheets(worksheet="users_4c_videos"):
    """
...
def user_exists_in_gsheets(user_id, worksheet="users_4c_videos"):
    """
...
def get_all_user_ids_from_gsheets(worksheet="users_4c_videos"):
    """
